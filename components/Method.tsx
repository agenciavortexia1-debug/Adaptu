...
const Method: React.FC = () => {
  return (
    <section id="method" className="py-24 bg-slate-900 scroll-mt-16 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl lg:text-4xl font-extrabold text-white mb-6">Como invertemos a lógica do mercado</h2>
        ...
        <div className="grid lg:grid-cols-3 gap-12 relative">
          ...
          {[
            ...
            <div key={idx} className="flex flex-col items-center text-center p-6 group">
              <div className={`w-16 h-16 ${item.color} text-slate-950 rounded-lg flex items-center justify-center text-2xl font-bold mb-6 shadow-lg group-hover:scale-110 transition-transform`}>
                {item.step}
              </div>
